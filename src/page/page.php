...
<html lang="en">
  <head>
    ...
    <!-- ICONS -->
    <script
      src="https://kit.fontawesome.com/e0b8ba43a6.js"
  ...
  <body id="home">
    ...
    <header>
      ...
      <div class="plus-social-container inactive">
        <a href=""
          ><i class="fa-regular fa-circle-down"></i> download my resume</a
        >
        <a href="/#contact"><i class="fa-regular fa-message"></i> contact me</a>
        <span class="plus-social-icons">
          <a href="https://www.instagram.com/lepremieraxel/" target="_blank"
            ><i class="fa-brands fa-instagram"></i
          ></a>
          <a href="https://github.com/lepremieraxel" target="_blank"
            ><i class="fa-brands fa-github"></i
          ></a>
          <a href="mailto:hello@axelmarcial.com"
